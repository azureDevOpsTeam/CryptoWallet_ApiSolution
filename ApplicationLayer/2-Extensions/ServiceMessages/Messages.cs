namespace ApplicationLayer.Extensions.ServiceMessages
{
    ...
    {
        public static string FailedInClientAppId = "خطایی در پروسه ی گرفتن کلاینت اپ آیدی رخ داده است";

        public static string NoAccessKindFind = "اکسس کایندی برای اضافه کردن پیدا نشد";

        public static string FailedInFetchingComponentList = "خطایی در پروسه ی گرفتن لیست کامپوننت رخ داده است";

        public static string FailedInFetchingParentComponent = "در گرفتن لیست کامپوننت والد، خطایی رخ داده است";

        public static string FailedInFetchingComponentByFilter = "در گرفتن کامپوننت با فیلتر، خطایی رخ داده است";

        public static string FailedInFetchingComponentBySearchTerm = "در جستجوی کامپوننت، خطایی رخ داده است";

        public static string FailedInFindingComponent = "کامپوننتی پیدا نشد";
    }
